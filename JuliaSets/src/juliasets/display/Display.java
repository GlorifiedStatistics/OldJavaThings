...
import juliasets.Complex;
import juliasets.JuliaSet;
import juliasets.JuliaSets;
import juliasets.Utils;
...
public class Display extends javax.swing.JFrame {
    ...
    public Display(JuliaSet js) {
        this.js = js;
        initComponents();
        this.updateImage();
    }
    
    public Display(JuliaSet js, Complex center, double delta) {
        this.js = js;
        initComponents();
        this.center = center;
        this.delta = delta;
